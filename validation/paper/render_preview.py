...
FIGFILES = {
    ...
    14: "fig9_crowded_field.png",            # 3.15 밀집장
    15: "fig7_reference_crosscheck.png",     # 3.16 참조 목록
    16: "fig8_cmd_reproduction.png",         # 3.17 CMD 재현
    17: "fig_timeseries_validation.png",     # 3.18 시계열 (SYSREM·PDM)
