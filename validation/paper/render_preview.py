...
FIGFILES = {
    ...
    9:  "fig2_error_model.png",              # 3.10 오차 모형
    10: "fig3_parameter_sweep.png",          # 3.11 민감도
    11: "fig4_crosscheck_sep.png",           # 3.12 합성 독립 엔진
    12: "fig_iraf_crosscheck.png",           # 3.13 실측 독립 엔진(NGC6811 499별)
    13: "fig9_crowded_field.png",            # 3.15 밀집장
    14: "fig7_reference_crosscheck.png",     # 3.16 참조 목록
    15: "fig8_cmd_reproduction.png",         # 3.17 CMD 재현
    16: "fig_timeseries_validation.png",     # 3.18 시계열 (SYSREM·PDM)
