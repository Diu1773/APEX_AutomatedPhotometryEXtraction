...
FIGFILES = {
    ...
    14: "fig_timeseries_validation.png",     # 3.15 시계열 (SYSREM·PDM)
    15: "fig6_qc_validation.png",            # 3.16 프레임 QC
    16: "fig_detection_threshold.png",       # 3.17 검출 문턱 오염
...
CAPTIONS = {
 ...
 9: r"합성 참값에서 APEX와 독립 구현 엔진 SEP \citep{barbary2016}의 일치(별 95개): MAD $0.006$등급, Pearson $r=0.99995$. 같은 화소에 두 독립 엔진이 같은 플럭스를 낸다.",
