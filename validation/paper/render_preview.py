...
FIGFILES = {
    ...
    15: "fig_detection_threshold.png",       # 3.17 검출 문턱 오염
    16: "fig_lc_yzboo.png",                  # 4    과학 적용(YZ Boo)
}
