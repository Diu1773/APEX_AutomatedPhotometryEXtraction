...
- 수치는 항상 "APEX(C3-61000 CMOS)에서" 로 보고. `REPRODUCTION_STATUS.md`에 명문화."""),
    N("dec_synth_ok", "합성 낙관 반증", 4, """# "합성이 낙관적" 일반화는 틀림 (실측으로 반증)
M67 i(어두운하늘·샤프) 실측 m50 17.65 = 합성 17.59. 격차는 프레임 품질(sky·seeing) 탓.
Haynes 우려는 '실측으로도 검증하라'로 수용하되 낙관 프레이밍은 그림에서 제거."""),
