...
## Figure 8 — CMD reproduction across three independent photometric systems

![Figure 8](figures/fig8_cmd_reproduction.png)

Vector: [`figures/fig8_cmd_reproduction.pdf`](figures/fig8_cmd_reproduction.pdf) · Script: [`fig8_cmd_reproduction.py`](fig8_cmd_reproduction.py)
...
**(a)** The NGC 6811 Johnson CMD ($V$ vs $B-V$) for 1921 stars, from APEX
...
a root-mean-square of **19 mmag** across the main sequence,
...
Pan-STARRS 1 system ($g$ vs $g-r$, 1928 stars): the identical morphology
...
Vector: [`figures/fig9_crowded_field.pdf`](figures/fig9_crowded_field.pdf) · Script: [`fig9_crowded_field.py`](fig9_crowded_field.py)
...
![Figure 12](figures/fig12_preproc_crosscheck.png)

Vector: [`figures/fig12_preproc_crosscheck.pdf`](figures/fig12_preproc_crosscheck.pdf) · Script: [`fig12_preproc_crosscheck.py`](fig12_preproc_crosscheck.py)
