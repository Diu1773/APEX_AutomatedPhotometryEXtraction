...
CMD_TOML_KEY_MAP: tuple[tuple[tuple[str, ...], str], ...] = (
    (('io', 'data_dir'), 'data_dir'),
    (('io', 'filename_prefix'), 'filename_prefix'),
    (('io', 'result_dir'), 'result_dir'),
    (('io', 'cache_dir'), 'cache_dir'),
...
LC_TOML_KEY_MAP: tuple[tuple[tuple[str, ...], str], ...] = (
    (('io', 'data_dir'), 'data_dir'),
    (('io', 'filename_prefix'), 'filename_prefix'),
    (('io', 'result_dir'), 'result_dir'),
    (('io', 'cache_dir'), 'cache_dir'),
...
# Keep the runtime mode maps composed from the shared groups above. The expanded
# literals above are retained as historical context, but callers use these
# canonical composed maps.
