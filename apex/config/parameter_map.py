...
COMMON_TOML_KEY_MAP: tuple[tuple, ...] = (
    ...
    (('photometry', 'scales', 'aperture_scale'), 'phot_aperture_scale', 'float', 1.0),
    (('photometry', 'scales', 'annulus_scale'), 'fitsky_annulus_scale', 'float', 4.0),
    (('photometry', 'scales', 'dannulus_scale'), 'fitsky_dannulus_scale', 'float', 2.0),
    ...
    (('photometry', 'radii', 'sigma_clip'), 'annulus_sigma_clip', 'float', 3.0),
