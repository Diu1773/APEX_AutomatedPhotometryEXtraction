...
COMMON_TOML_KEY_MAP: tuple[tuple, ...] = (
    ...
    # scale optimiser with a range and a step and there is no optimiser, which
    # is why 0.8 sitting exactly on `small_scale_min` looked deliberate and was
    # not. Kept so existing configs still load; do not add more.
    ...
    (('master_editor', 'search_radius_px'), 'search_radius_px', 'float', 7.0,
     {'label': 'Search Radius (px)', 'lo': 1.0, 'hi': 50.0, 'step': 0.5, 'decimals': 2}),
    (('master_editor', 'bulk_drop_box_px'), 'bulk_drop_box_px', 'int', 200,
     {'label': 'Remove Box Size (px)', 'lo': 10, 'hi': 2000, 'step': 10}),
    (('master_editor', 'gaia_add_max_sep_arcsec'), 'gaia_add_max_sep_arcsec', 'float', 2.0,
     {'label': 'Gaia Add Max Sep (\")', 'lo': 0.1, 'hi': 10.0, 'step': 0.1, 'decimals': 1}),
...
CMD_ONLY_TOML_KEY_MAP: tuple[tuple, ...] = (
    ...
    (('master_editor', 'membership_overlay_enable'), 'step8_membership_overlay_enable', 'bool', False,
     {'label': 'Membership Overlay',
      'check_text': 'Enable membership color overlay'}),
    (('master_editor', 'membership_threshold'), 'step8_membership_threshold', 'float', 0.5,
     {'label': 'Membership P threshold', 'lo': 0.0, 'hi': 1.0, 'step': 0.05, 'decimals': 2}),
