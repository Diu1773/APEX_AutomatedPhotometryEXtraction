...
class Parameters:
    ...
    def _load_from_file(path: Path) -> types.SimpleNamespace:
        ...
        P = types.SimpleNamespace(
            ...
            # Step 7 is shared with CMD; these must match parameters_cmd.py or
            ...
            psf_n_stars_max=_geti(raw, "psf_n_stars_max", 0),
            ...
            psf_flux_scale_min_snr=_getf(raw, "psf_flux_scale_min_snr", 50.0),
            psf_flux_scale_min_stars=_geti(raw, "psf_flux_scale_min_stars", 8),
            ...
            psf_fit_shape_fwhm_mult=_getf(raw, "psf_fit_shape_fwhm_mult", 2.4),
            ...
            psf_fitter_max_iter=_geti(raw, "psf_fitter_max_iter", 6),
            ...
            psf_epsf_sharp_lo=_getf(raw, "psf_epsf_sharp_lo", 0.3),
            psf_epsf_sharp_hi=_getf(raw, "psf_epsf_sharp_hi", 0.8),
            psf_epsf_round_abs_max=_getf(raw, "psf_epsf_round_abs_max", 0.5),
            psf_epsf_elong_max=_getf(raw, "psf_epsf_elong_max", 1.3),
            ...
            psf_core_cut_enable=_as_bool(raw.get("psf_core_cut_enable", "false"), False),
            psf_core_cut_center_mode=str(raw.get("psf_core_cut_center_mode", "auto")).strip().lower() or "auto",
            psf_core_cut_x_px=_getf(raw, "psf_core_cut_x_px", 0.0),
            psf_core_cut_y_px=_getf(raw, "psf_core_cut_y_px", 0.0),
            psf_core_cut_radius_px=_getf(raw, "psf_core_cut_radius_px", 0.0),
            psf_core_cut_radius_fwhm_mult=_getf(raw, "psf_core_cut_radius_fwhm_mult", 20.0),
            psf_core_cut_auto_cell_fwhm_mult=_getf(raw, "psf_core_cut_auto_cell_fwhm_mult", 8.0),
            psf_core_cut_auto_min_density_ratio=_getf(raw, "psf_core_cut_auto_min_density_ratio", 1.5),
            psf_core_cut_auto_min_sources=_geti(raw, "psf_core_cut_auto_min_sources", 50),
            psf_core_cut_max_exclude_frac=_getf(raw, "psf_core_cut_max_exclude_frac", 0.70),
            psf_substar_iters=_geti(raw, "psf_substar_iters", 1),
            ...
            psf_postfit_snr_min=_getf(raw, "psf_postfit_snr_min", 3.0),
            psf_postfit_qfit_max=_getf(raw, "psf_postfit_qfit_max", 3.0),
            psf_postfit_reduced_chi2_max=_getf(raw, "psf_postfit_reduced_chi2_max", 25.0),
            psf_blend_residual_ratio=_getf(raw, "psf_blend_residual_ratio", 0.3),
            psf_use_grouper=_as_bool(raw.get("psf_use_grouper", "false"), False),
            psf_grouper_max_size=_geti(raw, "psf_grouper_max_size", 3),
