...
MODULES = [
    ...
    "apex.gui.workflow.step5_aperture_photometry",
    "apex.gui.workflow.step6_wcs_plate_solving",
    "apex.gui.workflow.step7_ref_build",
    "apex.gui.workflow.step8_star_id_matching",
    "apex.gui.workflow.cmd.step1_file_selection",
    "apex.gui.workflow.cmd.step6_psf_photometry",
    "apex.gui.workflow.cmd.step10_master_id_editor",
    "apex.gui.workflow.cmd.step11_zeropoint_calibration",
    "apex.gui.workflow.cmd.step12_cmd_plot",
    "apex.gui.workflow.cmd.step13_isochrone_model",
    "apex.gui.workflow.lc.step1_file_selection",
    "apex.gui.workflow.lc.step9_target_selection",
    "apex.gui.workflow.lc.step10_lightcurve_builder",
    "apex.gui.workflow.lc.step11_detrend_merge",
    "apex.gui.workflow.lc.step12_period_analysis",
